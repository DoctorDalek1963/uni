...
&= \f12 \big( \cos x \cos 3t - \sin x \sin 3t + \cos x \cos 3t + \sin x \sin 3t \big) \\
    &\qquad + \f13 \sin(x + 3t) - \f13 \sin(x - 3t) \\[0.5ex]
&= \cos x \cos 3t + \f13 \big( \sin x \cos 3t + \cos x \sin 3t - (\sin x \cos 3t - \cos x \sin 3t) \big) \\[0.5ex]
&= \cos x \cos 3t + \f23 \cos x \sin 3t \\[0.5ex]
&= \cos x \l( \cos 3t + \f23 \sin 3t \r)
\end{align*}

So if $x_n = \df{2n + 1}2 \pi$ then $\cos x_n = 0$ and so \[
u(x_n, t) = \cos x_n \l( \cos 3t + \f23 \sin 3t \r) = 0
\] as required.
