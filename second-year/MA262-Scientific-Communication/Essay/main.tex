...
% TODO: Define eta reduction
\end{defn}

% TODO: Give an algorithm to decide which $\beta$-redexes to contract and in what order. We obviously don't want $\Omega \bcon \Omega$

% TODO: Add margin notes for Tim
