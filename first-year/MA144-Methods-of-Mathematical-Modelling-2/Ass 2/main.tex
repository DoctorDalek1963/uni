...
\end{align*}
% and \begin{align*}
% \pddd 2ut &= \pdiff t \l( \pdd ft \times \diff t (x+ct) + \pdd gt \times \diff t (x-ct) \r)\\[1ex]
% &= \pdiff t \l( c \pdd ft - c \pdd gt \r)\\[1ex]
% &= c \l( \pddd 2ft - \pddd 2gt \r)
% \end{align*}
...
% TODO: Sketch level curves

\subsection{~}

% TODO: Draw z=f(x,y) with Python
