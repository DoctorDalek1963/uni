...
\begin{questionbody}
Let $f \colon (-\infty, 0] \to \R$ and $g \colon [0, \infty) \to \R$ both be continuous on their entire domain. % chktex 9
...
\begin{questionbody}
Suppose that $f \colon [0, \infty) \to \R$ is continuous and that $f(x) \to L$ as $x \to \infty$. Show that $f$ is bounded above and below on $[0, \infty)$. % chktex 9
...
The function $f(x) = 1 - \df{1}{1+x}$ is defined on $[0, \infty)$ % chktex 9
